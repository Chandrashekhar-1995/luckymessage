...
const page = () => {
  ...
  const fetchAcceptMessage = useCallback(async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: axiosError.response?.data.message || "Failed to featch message settings",
        variant:"destructive"
      })
    }
    finally {
  ...
  return (
    <div className="my-8 mx-4 md:mx-8 lg:mx-auto p-6 bg-white rounded w-full max-w-6xl">
      ...
      <div className="mb-4">
        <Switch {...register('acceptMessages')} checked={acceptMessages} onCheckedChange={handleSwithChange} />
        <span className="ml-2">
